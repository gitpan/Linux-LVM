# This Makefile is for the Linux::LVM extension to perl.
#
...
#     ABSTRACT_FROM => q[LVM.pm]
#     AUTHOR => q[Chad Kerner <ckerner@amdocs.com>]
#     NAME => q[Linux::LVM]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[LVM.pm]
...
manifypods : pure_all LVM.pm
	@$(POD2MAN) \
	LVM.pm \
	$(INST_MAN3DIR)/Linux::LVM.$(MAN3EXT)
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{LVM.pm blib/lib/Linux/LVM.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
